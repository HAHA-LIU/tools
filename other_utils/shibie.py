...
def TestFunc(img):
    pd_id           = "119795"     #用户中心页可以查询到pd信息
    pd_key          = "/APpmbjMCuCq6qHxOjez730DWuRlwwsX"
    app_id          = "319795"     #开发者分成用的账号，在开发者中心可以查询到
    app_key         = "iAqzTJoyPhIc7Umo9uw1u3mS+7TClZHP"
    #识别类型，
    ...
    rsp =  api.PredictFromFileExtend(pred_type,file_name)   # 直接返回识别结果
    return rsp
