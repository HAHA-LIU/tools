...
sql = "SELECT * FROM dj_users WHERE role='2'"
...
for i in result:
    ...
    new_pass = ''
# [{"url":"/cars/160377869400092478.png"},{"url":"/cars/160377870700057557.png"},{"url":"/cars/160377870900090100.png"}]
    ...
    sql2 = "insert into `bf-db2`.sys_user(id,open_id,login_name,password,mobile,user_type,active_flag,auth_flag,login_flag," \
       "create_date,remarks,del_flag) values ('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}')"\
        .format(i[0],str(uuid.uuid4()).replace('-',''),i[1],new_pass,i[3],'3','1','1','1',time_s,remarks,'0')
    cur.execute(sql2)

    # 插入用户角色关系表
    sql3 = "insert into `bf-db2`.sys_user_role values ('{}','{}'),('{}','{}')".format(i[0],'0',i[0],'9')
    cur.execute(sql3)
    ...
    sql4 = "insert into `trade-info2`.info_user_message(id,user_id,nick_name,phone,from_type,del_flag," \
        ...
        i[0],other_name,i[3],'4','0',time_s,remarks)
    cur.execute(sql4)
